...
export default function SocialLogin({ onSocialLogin }: { onSocialLogin: (provider: string) => void }) {
    ...
    return (
        <View className="flex gap-3">
            ...
            <Pressable
                ...
                className="flex-row gap-2 items-center justify-center w-full py-4 bg-background-0 border border-outline-200 rounded-full active:opacity-70 active:scale-[0.98] shadow-ios-card">
                <GoogleIcon size={20} />
                <Text className="ml-2 text-headline font-semibold text-typography-900">
            ...
            <Pressable
                ...
                className="flex-row gap-2 items-center justify-center w-full py-4 bg-typography-900 rounded-full active:opacity-90 active:scale-[0.98] shadow-ios-card">
                <AntDesign name="apple1" size={20} color="white" />
                <Text className="ml-2 text-headline font-semibold text-white">
